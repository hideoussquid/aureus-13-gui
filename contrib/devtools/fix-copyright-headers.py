...
// Copyright (c) 2009-2012 The Aureus Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Aureus/$1-%s The Aureus/' %s"
REGEX_CURRENT= re.compile("%s The Aureus" % year)
