/* src/config/aureus-config.h.  Generated from aureus-config.h.in by configure.  */
/* src/config/aureus-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AUREUS_CONFIG_H

#define AUREUS_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Aureus Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Aureus Core"
...
#define PACKAGE_BUGREPORT "https://github.com/aureus/aureus/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Aureus Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Aureus Core 0.13.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aureus"
