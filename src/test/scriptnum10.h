...
#ifndef AUREUS_TEST_SCRIPTNUM10_H
#define AUREUS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Aureus Core 0.10.0, for cross-comparison.
 */
public:
