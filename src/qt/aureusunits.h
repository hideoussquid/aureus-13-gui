...
#ifndef AUREUS_QT_AUREUSUNITS_H
#define AUREUS_QT_AUREUSUNITS_H
...
/** Aureus unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AureusUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AureusUnits(QObject *parent);

    /** Aureus units.
      @note Source: https://en.aureus.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        AUR,
...
typedef AureusUnits::Unit AureusUnit;

#endif // AUREUS_QT_AUREUSUNITS_H
