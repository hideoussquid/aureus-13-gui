 ...
 */
#ifndef AUREUS_UTIL_H
#define AUREUS_UTIL_H
...
extern const char * const AUREUS_CONF_FILENAME;
extern const char * const AUREUS_PID_FILENAME;
...
{
    std::string s = strprintf("aureus-%s", name);
