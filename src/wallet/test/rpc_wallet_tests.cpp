// Copyright (c) 2013-2015 The Aureus Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CAureusAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CAureusAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CAureusAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CAureusAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CAureusAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAureusAddress(arr[0].get_str()).Get() == demoAddress.Get());
