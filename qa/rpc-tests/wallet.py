...
class WalletTest (AureusTestFramework):
    ...
    def run_test (self):
        ...
        # node0 should end up with 100 AUR in block rewards plus fees, but
        ...
        # Send 10 AUR with subtract fee from amount
        ...
        # Sendmany 10 AUR with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/aureus/aureus/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
