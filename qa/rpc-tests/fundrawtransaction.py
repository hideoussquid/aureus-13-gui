...
class RawTransactionsTest(AureusTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid aureus address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid aureus address" in e.error['message'])
