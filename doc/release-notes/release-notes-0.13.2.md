Aureus Core version 0.13.2 is now available from:

  <https://aureus.org/bin/aureus-core-0.13.2/>
...
- #8908 `4a974b2` Update aureus-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow aureus-tx to create v2 transactions (AURdrak)
