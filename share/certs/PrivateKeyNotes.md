...
unlocked to sign the Aureus-Qt.app bundle.
...
allowing somebody to distribute a Aureus-Qt.app or aureus-qt-setup.exe with a valid
...
that the aureus-qt.exe file inside the installer had not been tampered with.
